...
vicon_sub = rospy.Subscriber('/pose_stamped', PoseStamped, vicon_cb, queue_size=100)
odom_pub = rospy.Publisher('/fake_odom', Odometry, queue_size=100)
...
while not rospy.is_shutdown():
    ...
    if counter > 0:
        ...
        br.sendTransform((x,y,z),[pose.pose.orientation.x, pose.pose.orientation.y,pose.pose.orientation.z,pose.pose.orientation.w],rospy.Time.now(), "base_footprint","fake_odom")
